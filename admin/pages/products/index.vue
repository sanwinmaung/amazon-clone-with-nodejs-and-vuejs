          ...
          <div class="a-section">
            ...
            <form action>
              ...
              <div class="a-spacing-top-medium">
                ...
                <input type="text" class="a-input-text" v-model="title" style="width: 100%" />
              </div>

              <!-- Price Input-->
              <div class="a-spacing-top-medium">
                <label style="margin-botton: 0px;">Price</label>
                <input type="text" class="a-input-text" v-model="price" style="width: 100%" />
              </div>

              <!-- StockQuantity Input-->
              <div class="a-spacing-top-medium">
                <label style="margin-botton: 0px;">Stock Quantity</label>
                <input type="text" class="a-input-text" v-model="stockQuantity" style="width: 100%" />
              </div>
